...
test("portal gateway explains authentication, privacy, and two-character rule",()=>{assert.match(authPanel,/Continue with Discord/);assert.match(portal,/Maximum two characters/);assert.match(portal,/Private until you publish/);assert.match(portal,/Website messages only/);});
