...
test("Students can only friend Students and Faculty can only friend Faculty",()=>{assert.match(roleMigration,/requester_role/);assert.match(roleMigration,/addressee_role/);assert.match(roleMigration,/sender_role/);assert.match(roleMigration,/target_role/);assert.match(roleMigration,/Students can only add students, and faculty can only add faculty/);assert.match(roleMigration,/before insert or update of requester_character_id,addressee_character_id/);});
