...
test("campus keeps fixture directory data labeled while public opportunities use the live portal flow",()=>{assert.match(directory,/DEVELOPMENT DATA/);assert.match(campus,/Apply in Student Portal/);assert.match(campus,/Published opportunities and application status/);assert.doesNotMatch(campus,/TEST LISTINGS/);});
