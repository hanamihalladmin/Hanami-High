...
export default function Home() {
  ...
  return (
    <main id="home" className="site-page">
      ...
      <footer><p>HANAMI HIGH SCHOOL • 花見高等学校 • HANAMI CITY • 2026</p><nav aria-label="Footer navigation"><a href="./about/#contact">Contact</a><a href="./portal/">Portal Help</a><a href="#home">Back to top ↑</a></nav></footer>
    </main>
  );
}
