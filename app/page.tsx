...
const navigation = [["Home", "#home"], ["About", "./about/"], ["Academics", "./academics/"], ["Campus Life", "./campus-life/"], ["Clubs", "./campus-life/#directory"], ["Calendar", "./calendar/"], ["News", "#news"], ["People", "./about/#directory"], ["Gallery", "./campus-life/#gallery"]] as const;
const quickLinks = [["A", "About Hanami", "./about/"], ["学", "Academic departments", "./academics/#departments"], ["C", "Clubs & organizations", "./campus-life/#directory"], ["E", "School calendar", "./calendar/"], ["J", "Campus opportunities", "./campus-life/#jobs"]] as const;
...
export default function Home() {
  ...
  return (
    <main id="home" className="site-page">
      ...
      <footer><p>HANAMI HIGH SCHOOL • 花見高等学校 • HANAMI CITY • 2006</p><nav aria-label="Footer navigation"><a href="./about/#contact">Contact</a><a href="./portal/help/">Portal Help</a><a href="#home">Back to top ↑</a></nav></footer>
    </main>
  );
}
