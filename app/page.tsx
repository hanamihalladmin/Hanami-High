  ...
  <section className={styles.main}>
   ...
   <div className={styles.content}>
    ...
    <div className={styles.dashboardGrid}>
     ...
     <section className={styles.card}><div className={styles.cardHeader}><h3>PORTAL ACCESS</h3><span>SCHOOL NETWORK</span></div><div className={styles.linkGrid}><a href="./portal/">Student Login</a><a href="./portal/">Faculty Login</a></div></section>
