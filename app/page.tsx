...
const navigation = [["Home", "#home"], ["About", "./about/"], ["Academics", "./academics/"], ["Campus Life", "#campus-life"], ["Clubs", "#clubs"], ["Calendar", "./academics/#calendar"], ["News", "#news"], ["People", "./about/#directory"], ["Gallery", "#gallery"]] as const;
const quickLinks = [["A", "About Hanami", "./about/"], ["学", "Academic departments", "./academics/#departments"], ["C", "Clubs & organizations", "#clubs"], ["E", "Academic calendar", "./academics/#calendar"], ["J", "Part-time jobs", "#jobs"]] as const;
    ...
    <main id="home" className="site-page">
      ...
      <div className="homepage-grid">
        ...
        <div className="main-column" id="main-content">
          ...
          <SiteSearch />
          <section className="feature-grid" id="news" aria-label="School news"><article className="feature-story"><p className="eyebrow">FEATURED ANNOUNCEMENT</p><p className="story-date">AUGUST 18, 2026</p><h2>Preparations begin for the Autumn Culture Festival</h2><p>Clubs may submit booth proposals through Friday. Student Council will publish the first approved roster next week.</p><a className="text-link" href="#calendar">View festival details →</a></article><div className="news-list"><div className="section-heading"><h2>LATEST NEWS</h2><a href="#news">View all</a></div><article><time>08.18</time><a href="#clubs">Club recruitment week opens Monday</a></article><article><time>08.17</time><a href="#academics">Honors course applications posted</a></article><article><time>08.15</time><a href="#jobs">New part-time positions added</a></article><article><time>08.12</time><a href="#people">Student Council welcomes new members</a></article></div></section>
          ...
          <section className="info-section campus-preview" id="campus-life"><div className="section-heading"><h2>CAMPUS LIFE</h2><a href="#clubs">Browse activities</a></div><div className="campus-columns"><article id="clubs"><b>THE CLUB DIRECTORY</b><h3>Find your place after the bell.</h3><p>Browse active sports, academic, arts, service, and special-interest clubs.</p><a href="#clubs">View club roster →</a></article><article id="jobs"><b>PART-TIME JOB BOARD</b><h3>Build experience off campus.</h3><p>Local opportunities and supervised internship-credit placements.</p><a href="#jobs">See open positions →</a></article></div></section>
