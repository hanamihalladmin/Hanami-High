...
export default function HomeDashboard({currentDate}:Props){
 ...
 return <main id="home" className={styles.shell}>
  <aside className={styles.rail} aria-label="Public website navigation">
   ...
   <div className={styles.railLinks}><a href="./newspaper/"><span>▤</span><b>Newspaper</b></a><a href="./about/"><span>◎</span><b>About</b></a><a href="./rules/"><span>◆</span><b>Rules</b></a><a href="./guide/"><span>?</span><b>Website Guide</b></a><a href="./apply/"><span>＋</span><b>Apply</b></a><a href="./changelog/"><span>↻</span><b>Updates</b></a><a href="./features/"><span>✦</span><b>Features</b></a></div>
  ...
  <section className={styles.main}>
   ...
   <div className={styles.content}><LiveAnnouncements/>
    {tab==="home"&&<div className={styles.tabView}><section className={styles.hero}><div className={styles.heroMain}><p className={styles.eyebrow}>HANAMI HIGH • SCHOOL HOME</p><h2>A school day is more than a schedule.</h2><p>Explore academics, student life, clubs, school traditions, and the stories shaping Hanami from one compact school dashboard.</p><div className={styles.actions}><button type="button" onClick={()=>setTab("academics")}>Explore academics</button><a href="./newspaper/">Read the Chronicle</a><a href="./apply/">Apply to Hanami</a><a href="./portal/">Open portal</a><a href="./guide/">Read website guide</a><a href="./changelog/">See website updates</a></div></div><aside className={`${styles.card} ${styles.todayCard}`}><div className={styles.cardHeader}><h3>TODAY AT HANAMI</h3><span>LIVE</span></div><p><b data-hanami-roleplay-clock>{currentDate.toUpperCase()}</b></p><LiveNextEvent/></aside></section><section className={styles.quickRow}><button type="button" onClick={()=>setTab("academics")}><b>Academics</b><span>Courses and pathways →</span></button><button type="button" onClick={()=>setTab("campus")}><b>Campus Life</b><span>Clubs and opportunities →</span></button><a href="./guide/"><b>Website Guide</b><span>Learn every website and portal feature →</span></a><a href="./portal/"><b>Portal</b><span>Student, Faculty, Admin & Owner →</span></a></section></div>}
