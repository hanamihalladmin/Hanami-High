 ...
 return <PublicSchoolShell active="home" sectionTitle="PUBLIC NETWORK" breadcrumb="Home" stickyUtility lastUpdated="08.25.2006">
  <div className={styles.stack}>
   ...
   <div className={styles.threeCol}>
    <section className={styles.box}>
     <div className={styles.boxHead}><h3>Academic Highlights</h3><a href="./academics/">View academics →</a></div>
     <div className={styles.boxBody}><p>Browse departments, course offerings, graduation requirements, school-year dates, honors pathways, and guidance resources.</p></div>
    </section>
    <section className={styles.box}>
     <div className={styles.boxHead}><h3>Student Life</h3><a href="./campus-life/">Explore →</a></div>
     <div className={styles.boxBody}><p>Find clubs, school activities, student opportunities, events, campus culture, and community resources.</p></div>
    </section>
    <section className={styles.box}>
     <div className={styles.boxHead}><h3>Hanami Chronicle</h3><a href="./newspaper/">Open news →</a></div>
     <div className={styles.boxBody}><p>School notices, feature stories, announcements, and updates from around campus in one public archive.</p></div>
    </section>
   </div>

   <section className={styles.box}>
    <div className={styles.boxHead}><h3>Upcoming School Events</h3><a href="./calendar/">Full calendar →</a></div>
    <div className={styles.boxBody}><LiveUpcomingEvents/></div>
   </section>
