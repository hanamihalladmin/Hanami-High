...
export default function AcademicsPage() {
  ...
  return <main className="site-page academics-page">
    ...
    <header className="school-header" aria-label="Hanami High header">
      ...
      <div className="nav-row"><nav aria-label="Primary navigation"><a href="../">Home</a><a href="../about/">About</a><a className="active" href="./">Academics</a><a href="../#campus-life">Campus Life</a><a href="../#clubs">Clubs</a><a href="#calendar">Calendar</a><a href="../#news">News</a><a href="../about/#directory">People</a><a href="../#gallery">Gallery</a></nav><a className="portal-button" href="../#portal-access">↪ Login / Portal</a></div>
    </header>
    ...
    <div className="academic-page-layout">
      ...
      <div className="academic-page-content">
        ...
        <section className="info-section" id="calendar"><div className="section-heading"><h2>2026–27 ACADEMIC CALENDAR</h2><span>JAPAN STANDARD TIME</span></div><div className="academic-timeline">{calendar.map(([date,title,copy])=><article key={title}><time>{date}</time><div><h3>{title}</h3><p>{copy}</p></div></article>)}</div><div className="calendar-actions"><a className="secondary-action" href="#calendar">View complete calendar</a><small>Portal calendars will include personal class, exam, and assignment dates.</small></div></section>
        ...
        <section className="info-section" id="guidance"><div className="section-heading"><h2>GUIDANCE COUNSELING</h2><span>PLAN • SUPPORT • PROGRESS</span></div><div className="guidance-grid"><div><p className="eyebrow">YOUR ACADEMIC PATH</p><h3>Planning should feel personal.</h3><p>Guidance counselors help students understand requirements, choose courses, explore future study and careers, arrange accommodations, and recover credits when plans change.</p><a className="primary-action" href="mailto:guidance@hanamihigh.example">Contact Guidance</a></div><ul><li><strong>Course planning</strong><span>Selection, prerequisites, and schedule changes</span></li><li><strong>Graduation checks</strong><span>Credit reviews and completion plans</span></li><li><strong>Advanced pathways</strong><span>Honors, independent study, and internships</span></li><li><strong>Future planning</strong><span>College, training, careers, and applications</span></li></ul></div></section>
      </div>
    </div>
    <footer><p>HANAMI HIGH SCHOOL • 花見高等学校 • HANAMI CITY • 2026</p><nav><a href="../about/#contact">Contact</a><a href="../#portal-access">Portal Help</a><a href="#academics-main">Back to top ↑</a></nav></footer>
  </main>;
}
