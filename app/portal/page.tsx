...
export default function PortalPage(){
  ...
  return <main className="site-page portal-page">
    ...
    <header className="school-header">
      ...
      <div className="brand-row"><a className="brand-lockup brand-link" href="../"><div className="school-mark current-school-mark"><img src="../hanami-high-portal-icon.png" alt="Hanami High"/></div><div><p className="jp-name">花見高等学校</p><p className="brand-name">HANAMI HIGH SCHOOL</p><p className="brand-subtitle">Student & Faculty Portal</p></div></a><div className="school-clock"><strong>{currentDate.toUpperCase()}</strong><span>HANAMI CITY • JAPAN STANDARD TIME • SECURE PORTAL GATEWAY</span></div></div>
    ...
    <div className="portal-gateway" id="portal-main"><section className="portal-intro"><p className="eyebrow">HANAMI HIGH • ACCOUNT GATEWAY</p><h1>Your school life,<br/>all in one place.</h1><p>Sign in with Discord, synchronize your school roles, choose who you are playing, and enter your private Hanami school desk.</p><PortalAuthPanel/></section><aside className="test-desk"><div className="window-title">MY HANAMI • TEST DESK</div><div className="test-character"><div className="avatar-placeholder">ST</div><div><p className="eyebrow">TEST CHARACTER</p><h2>Student Preview</h2><span>@test_student • Student</span></div></div><div className="desk-list"><p><b>08:00</b> Homeroom</p><p><b>09:15</b> English Language & Composition</p><p><b>15:30</b> Club activities</p></div><small>Preview only • No account data</small></aside></div>
