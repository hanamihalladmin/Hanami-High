...
export default function PortalPage(){
  ...
  return <main className="site-page portal-page">
    ...
    <header className="school-header">
      ...
      <div className="brand-row"><a className="brand-lockup brand-link" href="../"><div className="school-mark" style={{background:"transparent",border:0,boxShadow:"none"}}><img src="../hanami-high-portal-icon.png?v=20260821c" alt="Hanami High" style={{width:"100%",height:"100%",objectFit:"contain",background:"transparent"}}/></div><div><p className="jp-name">花見高等学校</p><p className="brand-name">HANAMI HIGH SCHOOL</p><p className="brand-subtitle">Student & Faculty Portal</p></div></a><div className="school-clock"><strong>{currentDate.toUpperCase()}</strong><span>HANAMI CITY • JAPAN STANDARD TIME • SECURE PORTAL GATEWAY</span></div></div>
