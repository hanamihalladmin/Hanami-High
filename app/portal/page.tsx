...
const tools=[
  ...
  ["✉","Hanami Messages","Private conversations, group chats, teacher messages, and office requests stay inside the website."],
  ["✦","Profile & Privacy","Build a personal page and choose public, friends-only, or private visibility."],
] as const;
...
export default function PortalPage(){
  ...
  return <main className="site-page portal-page">
    ...
    <header className="school-header">
      <div className="network-strip">HANAMI HIGH SCHOOL • SECURE STUDENT NETWORK • EST. 2006</div>
      ...
      <div className="nav-row"><nav><a href="../">School Home</a><a href="../about/">About</a><a href="../academics/">Academics</a><a href="../campus-life/">Campus Life</a></nav><a className="portal-button active" href="./">Login / Portal</a></div>
    </header>
    <div className="portal-gateway" id="portal-main">
      <section className="portal-intro"><p className="eyebrow">HANAMI HIGH • ACCOUNT GATEWAY</p><h1>Your school life,<br/>all in one place.</h1><p>Sign in with Discord, choose who you are playing, and enter your private Hanami school desk.</p><PortalAuthPanel/></section>
      <aside className="test-desk"><div className="window-title">MY HANAMI • TEST DESK</div><div className="test-character"><div className="avatar-placeholder">花</div><div><p className="eyebrow">TEST CHARACTER</p><h2>Student Preview</h2><span>@test_student • Student</span></div></div><div className="desk-list"><p><b>08:30</b> Homeroom</p><p><b>10:15</b> Literature & Composition</p><p><b>15:30</b> Club activities</p></div><small>Preview only • No account data</small></aside>
    </div>
    ...
    <footer><p>HANAMI HIGH SCHOOL • SECURE PORTAL FOUNDATION • 2026</p><nav><a href="../">School Home</a><a href="../about/#contact">Help</a><a href="#portal-main">Back to top ↑</a></nav></footer>
  </main>;
}
