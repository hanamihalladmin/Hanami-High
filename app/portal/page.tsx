...
export default function PortalPage(){
  ...
  return <main className="site-page portal-page">
    ...
    <footer><p>HANAMI HIGH SCHOOL • SECURE PORTAL FOUNDATION • 2026</p><nav><a href="../">School Home</a><a href="./admin/">Administration</a><a href="../about/#contact">Help</a><a href="#portal-main">Back to top ↑</a></nav></footer>
  </main>;
}
