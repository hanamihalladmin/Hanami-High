...
const STUDENT_TABS:Record<string,Target[]>={
 ...
 profile:[{view:"profile",subView:"profile",label:"My Profile"},{view:"profile",subView:"appearance",label:"Appearance"},{view:"profile",subView:"people",label:"Profiles"},{view:"profile",subView:"preferences",label:"Settings"}]
};
