...
type Preset={name:string;category:"Dividers"|"Stickers"|"Badges"|"Cards";widget_type:WidgetType;width:number;height:number;content:Record<string,string>;style:Record<string,string|number>};
...
export default function ProfileDecorativePresetGallery({accessToken,characterId,onAdded}:Props){
 const [category,setCategory]=useState<Preset["category"]>("Dividers");
 const [busy,setBusy]=useState("");
 const [notice,setNotice]=useState("");
 const categories:Preset["category"][]=["Dividers","Stickers","Badges","Cards"];
