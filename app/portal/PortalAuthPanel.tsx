...
export default function PortalAuthPanel(){
  ...
  const portalPath=activeCharacter?.role==="student"?"./student/":activeCharacter?.role==="faculty"?"./faculty/":null;
  const portalLabel=activeCharacter?.role==="student"?"Enter Student Portal":activeCharacter?.role==="faculty"?"Enter Faculty Portal":null;
