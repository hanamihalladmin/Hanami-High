...
export default function AdminWorkspace({accessToken,userId,access,ownerMode=false}:{accessToken:string;userId:string;access:Access;ownerMode?:boolean}){
 ...
 return <>
  ...
  {canEditContent&&<><AdminRoadmapManager accessToken={accessToken} userId={userId}/><AdminRoadmapOperationsPanel accessToken={accessToken} userId={userId} canModerate={canModerate}/><AdminCityTransitManager accessToken={accessToken}/><AdminCityLifecyclePanel accessToken={accessToken}/><AdminCommunityOperationsPanel accessToken={accessToken} userId={userId}/><AdminLoreCanonEditor accessToken={accessToken}/><AdminSchoolStatusManager accessToken={accessToken} userId={userId} access={access}/><AdminAnnouncementManager accessToken={accessToken} userId={userId} access={access}/><AdminEventManager accessToken={accessToken} userId={userId} access={access}/><AdminOpportunityManager accessToken={accessToken} userId={userId}/><AdminOfficeRequestManager accessToken={accessToken} userId={userId}/></>}
