...
type Props={character:ActiveCharacter|null};

const studentCards=[
  ["TODAY","Class schedule","Your enrolled classes and room changes will appear here."],
...
const facultyCards=[
  ["TODAY","Teaching schedule","Assigned classes, room changes, and office periods will appear here."],
...
export default function DashboardShell({character}:Props){
  ...
  return <section className={styles.dashboard} aria-labelledby="dashboard-title">
    ...
    <div className={styles.notice}><strong>DASHBOARD FOUNDATION</strong><span>This is the real role-aware portal shell. Schedule and coursework cards are placeholders until their database modules are connected.</span></div>
