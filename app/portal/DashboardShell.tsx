...
export default function DashboardShell({character,accessToken}:Props){
  ...
  const isStudent=character.role==="student";const ownerTestFaculty=!isStudent&&character.handle.startsWith("testfaculty_");
  ...
  return <section className={styles.dashboard} aria-labelledby="dashboard-title">
    ...
    <CollapsibleSection title="Search Everything" subtitle="Permission-aware Hanami search"><SearchEverythingPanel accessToken={accessToken} characterId={character.id}/></CollapsibleSection>
    ...
    <CollapsibleSection title="Friends" subtitle="Character friendships and platonic relationship labels"><FriendsPanel accessToken={accessToken} characterId={character.id}/></CollapsibleSection>
    ...
    <div className={styles.quickbar}><strong>{isStudent?"STUDENT QUICK LINKS":"FACULTY QUICK LINKS"}</strong><span>{isStudent?"Search Everything • Notifications • Accessibility • Announcements • Hall Passes • Attendance Excuses • Detention • Session • School ID • Classes • Assignments • Academic Record • Homeroom • To-Do • Counseling • Health • Campus Opportunities • Organizations • Elections • Forums • Bulletin Boards • Study Groups • Newspaper • Galleries • School Office Requests • Forms • Documents • Handbook • Traditions • IT Help • Appeals • Bug Reports • Messages • Friends • Platonic Relationships • Profile & Privacy • Profile Templates • Profile Studio":`Search Everything • Notifications • Accessibility • Announcements • Hall Pass Review • Attendance Excuse Review • Detention • Session • School ID • Classes • Rosters • Assignments • Attendance • Report Cards${nurseEligible?" • Nurse Dashboard":""} • Forums • Bulletin Boards • Newspaper • Galleries • School Office Requests • Forms • Documents • Handbook • Traditions • IT Help • Appeals • Bug Reports • Messages • Friends • Profile & Privacy • Profile Templates • Profile Studio`}</span></div>
  </section>;
}
