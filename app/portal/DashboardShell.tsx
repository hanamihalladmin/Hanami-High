...
export default function DashboardShell({character,accessToken}:Props){
  ...
  return <section className={styles.dashboard} aria-labelledby="dashboard-title">
    ...
    <div className={styles.notice}><strong>LIVE DASHBOARD</strong><span>{isStudent?"School Notices, Student Schedule, Coursework, Campus Activities, Hanami Messages, Friends, Profile & Privacy, Profile Templates, Hanami Profiles, and Profile Studio are connected to live Supabase data.":"School Notices, Faculty Schedule, Course Management, Grading, Student Advising, Hanami Messages, Friends, Profile & Privacy, Profile Templates, Hanami Profiles, and Profile Studio are connected to live Supabase data."}</span></div>
    ...
    <div className={styles.quickbar}><strong>{isStudent?"STUDENT QUICK LINKS":"FACULTY QUICK LINKS"}</strong><span>{isStudent?"Notices • Classes • Assignments • Campus • Messages • Friends • Profile Studio":"Notices • Classes • Rosters • Assignments • Messages • Friends • Profile Studio"}</span></div>
  </section>;
}
