...
export default function ProfileDesignWorkspace({accessToken,characterId}:Props){
  ...
  return <>
    ...
    <div style={studioStyle}><ProfileStudioPanel key={`${characterId}-${revision}`} accessToken={accessToken} characterId={characterId}/></div>
  </>;
}
