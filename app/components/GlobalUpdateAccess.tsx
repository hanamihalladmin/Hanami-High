...
export default function GlobalUpdateAccess(){
 ...
 return <nav aria-label="Hanami development links" style={{position:"fixed",right:12,bottom:12,zIndex:1000,display:"flex",gap:6,flexWrap:"wrap",justifyContent:"flex-end",maxWidth:320}}>
