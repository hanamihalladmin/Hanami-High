...
export default function GlobalUpdateAccess(){
 ...
 return <nav aria-label="Hanami development links" style={{position:"fixed",right:12,bottom:12,zIndex:1000,display:"flex",gap:6,flexWrap:"wrap",justifyContent:"flex-end",maxWidth:440}}>
  {inPortal&&<a href="/Hanami-High/portal/experience/" style={{display:"inline-flex",alignItems:"center",gap:6,padding:"8px 10px",border:"1px solid #6d7280",borderRadius:0,background:"rgba(255,255,255,.96)",color:"#26364d",textDecoration:"none",font:"600 11px Arial,Helvetica,sans-serif",boxShadow:"0 2px 8px rgba(0,0,0,.12)"}}>◎ Student Experience</a>}
