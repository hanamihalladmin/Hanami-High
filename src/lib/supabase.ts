...
import type { HanamiCreatorFollowingDatabase } from '../types/database-creator-following'
...
export const supabase = hasSupabaseConfig
  ? createClient<HanamiCreatorFollowingDatabase>(supabaseUrl!, supabasePublishableKey!, {
      auth: {
        persistSession: true,
