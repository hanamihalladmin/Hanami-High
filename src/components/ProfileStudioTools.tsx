...
import { ProfileWidgetLibraryPage } from './ProfileWidgetLibraryPage'

type ToolTab = 'style' | 'background' | 'layout' | 'widgets' | 'cosmetics'
    ...
    {open && <div className="profile-studio-tools-backdrop" role="dialog" aria-modal="true" aria-label="Profile customization">
      <section className="profile-studio-tools-modal">
        ...
        <div className="profile-studio-tools-body">
          ...
          {tab === 'widgets' && <ProfileWidgetLibraryPage />}
